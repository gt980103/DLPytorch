# -*- coding: utf-8 -*-
"""
Created on Mon Mar 16 23:09:23 2020
...
if __name__=="__main__":
    ...
    # 导入数据，定义数据接口
    testdata  = torchvision.datasets.MNIST(root="data", train=False, download=True, transform=mnist_transform)
